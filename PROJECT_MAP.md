# Shop Price Online (раніше Insta-Data / Monte-Shop-Price) — Project Map

## 🆕 Актуальний стан (2026-08-31) — мультикраїна: ME + UA

Проект перейменований на **Shop Price Online** (2026-08-29). Тепер це не лише Чорногорія: є перемикач країни (ME/UA) на сайті й в адмінці, і 5 живих реальних джерел цін для України (Novus, Varus, Сільпо, Фора, **АТБ** — тепер реально автоматизований через Selenium/`undetected-chromedriver` + віртуальний дисплей Xvfb, Cloudflare більше не блокує) поруч із оригінальним ME-пайплайном (cijene.me → Aroma/Voli/HDL/IDEA). Коло не має онлайн-каталогу цін узагалі — має лише 7 товарів, зібраних вручну зі скан-картинок стороннього сайту (`merge_kolo_manual.py`), реальний обсяг непорівнянний з рештою.

**Це історичний документ, оновлюваний по фазах — детальний, датований changelog з причинами кожного бага/рішення живе в [`CLAUDE.md`](CLAUDE.md) (записи 24-38 — все про Shop Price Online rename, country selector, UA-скрапери, автоматизацію АТБ, фікси зіставлення товарів, нові категорії). Читайте CLAUDE.md для найсвіжішого контексту, цей файл — довідник по архітектурі попередніх фаз.**
...
**Статус:** Phase 1 ✅ (Landing Page) → Phase 2 ✅ (Backend + Data Seeding) → Phase 3 ✅ (Live real-data scraping через cijene.me + MongoDB-персист) → Phase 5 ✅ (Shop Price Online rename, мультикраїна ME/UA, 4 живих UA-скрапери — деталі в CLAUDE.md)

> ⚠️ Ця мапа довго містила вигадані/суперечливі дані (файл був закомічений одним махом 2026-07-02 з датою "2026-06-23"). Секції нижче виправлені за фактичним кодом станом на 2026-07-07 — тобто описують ТІЛЬКИ Чорногорію/Phase 1-4. Для UA/мультикраїни дивіться CLAUDE.md.
