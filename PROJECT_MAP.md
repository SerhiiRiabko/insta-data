...
## 🆕 Актуальний стан (2026-08-30) — мультикраїна: ME + UA

Проект перейменований на **Shop Price Online** (2026-08-29). Тепер це не лише Чорногорія: є перемикач країни (ME/UA) на сайті й в адмінці, і 4 живих реальних джерела цін для України (Novus, Varus, Сільпо, Фора) поруч із оригінальним ME-пайплайном (cijene.me → Aroma/Voli/HDL/IDEA). АТБ написаний, але вимкнений (Cloudflare); Коло не має онлайн-каталогу цін узагалі.

**Це історичний документ, оновлюваний по фазах — детальний, датований changelog з причинами кожного бага/рішення живе в [`CLAUDE.md`](CLAUDE.md) (записи 24-29 — все про Shop Price Online rename, country selector, UA-скрапери, фікс зіставлення товарів). Читайте CLAUDE.md для найсвіжішого контексту, цей файл — довідник по архітектурі попередніх фаз.**
